...
public class Lab {
	...
	public static void main(String[] args) {
		...
		numberlist.add(5);
		numberlist.add(1);
		Set<Integer> evens = evenFinder(numberlist);
		...
		dictionary.put("apple", "a crunchy fruit, that is red");
		dictionary.put("banana","a yellow fruit, that is mushy");
		dictionary.put("java", "a oob programming langauge, created in 1995");
		dictionary.put("apple", "a crunchy fruit that is red");
		...
		Map<Character, Integer> counts=countStartingLetters(convertList);
	...
	public static String lookupValue(HashMap<String, String> map, String string) {
	...
	public static Set<Integer> evenFinder(Set<Integer> integers) {
		// TODO Auto-generated method stub
